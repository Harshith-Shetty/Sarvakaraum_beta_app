...
void main() => runApp(MaterialApp(home: dashboard_hindi()));

class dashboard_hindi extends StatefulWidget {
  @override
  dashboard_hindiState createState() => new dashboard_hindiState();

}

class dashboard_hindiState extends State<dashboard_hindi> {
  @override
